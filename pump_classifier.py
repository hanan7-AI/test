...
def preprocess_audio(file_path, target_sample_rate=16000, desired_length=16000):
    # Load the WAV file
...
interpreter = tflite.Interpreter(model_path="model_pump.tflite")
...
input_audio = preprocess_audio("your_audio_file.wav")
